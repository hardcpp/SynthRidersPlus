...
namespace ChatPlexMod_ChatIntegrations.Events
{
    ...
    public class ChatPointsReward : Interfaces.IEvent<ChatPointsReward, Models.Events.ChatPointsReward>
    {
        ...
        public override sealed void BuildUI(Transform p_Parent)
        {
            ...
            Action<CP_SDK.UI.Components.CText> l_ControlsTextStyleC = (x) => x.SetStyle(FontStyles.Bold | FontStyles.Underline).SetColor(Color.yellow).SetAlign(TextAlignmentOptions.Center);
            ...
            XUIElements = new IXUIElement[]
            {
                XUIHLayout.Make(
                    ...
                    .SetMinWidth(115f).SetWidth(115f)
                )
